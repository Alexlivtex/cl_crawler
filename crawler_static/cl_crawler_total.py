...
node_xml = 'record_nocode_database.xml'
code_xml = 'record_code_database.xml'
europe_xml = 'record_europe_database.xml'
http_download_xml = 'record_http_database.xml'
online_cinema_xml = 'online_cinema_database.xml'
techincal_discussion_xml = 'tech_discuss_database.xml'
new_generation_xml = 'new_generation_database.xml'
flag_of_dagal_xml = 'flag_of_dagal_database.xml'
literature_check_xml = 'literature_check_database.xml'

total_record_list = []

ULTIMATE_PAGE_BOUNDER = 1000
page_id = 0
nocode_base_url = 'http://cl.mocl.xyz/thread0806.php?fid=2&search=&page='
